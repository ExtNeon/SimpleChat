...
public class ThreadedHandledConnection extends Thread implements Closeable {
     ...
     */
    public synchronized String getReceiveBufContent(boolean clear) {
    ...
    public void justSendTextToSocket(String text) throws IOException {
